...
struct IsInTuple<T, std::tuple<Ts...>> {
  ...
  typedef
      typename SplitTuple<Tuple_type>::First_element_type First_element_type;
  typedef typename SplitTuple<Tuple_type>::Sub_tuple_type Sub_tuple_type;
  constexpr static bool value = std::is_same<T, First_element_type>::value ||
                                IsInTuple<T, Sub_tuple_type>::value;
};
...
struct IsSingleTypeTuple<std::tuple<Ts...>> {
  ...
  constexpr static bool value =
      std::is_same<
          First_element_type,
          typename SplitTuple<Sub_tuple_type>::First_element_type>::value &&
      IsSingleTypeTuple<Sub_tuple_type>::value;
};
...
template <typename TupleType>
inline constexpr bool is_single_type() {
  return IsSingleTypeTuple<TupleType>::value;
}
...
struct TupleSet<std::tuple<Ts...>> {
  ...
  typedef typename ExtendTupleSet<
      Sub_tuple_set_type, First_element_type,
      !IsInTuple<First_element_type,
                 Sub_tuple_set_type>::value>::Extended_tuple_type type;
};
...
struct ConcatenatedTuple<TupleType, TupleTypes...> {
  typedef typename ConcatenatedTuple<
      TupleType, typename ConcatenatedTuple<TupleTypes...>::type>::type type;
};
...
struct ConcatenatedTupleSet<TupleType, TupleTypes...> {
  typedef typename TupleSet<typename ConcatenatedTuple<
      typename TupleSet<TupleType>::type,
      typename ConcatenatedTupleSet<TupleTypes...>::type>::type>::type type;
};
