...
double torus_function(double x, double y, double z) {
  ...
  return x4 + y4 + z4 + 2 * x2 * y2 + 2 * x2 * z2 + 2 * y2 * z2 - 5 * x2 +
         4 * y2 - 5 * z2 + 4;
}
...
double chair_function(double x, double y, double z) {
  ...
  return x4 - 1.2 * x2 * y2 + 3.6 * x2 * z2 - 7.50 * x2 + y4 + 3.6 * y2 * z2 -
         7.50 * y2 + .2 * z4 - 7.50 * z2 + 64.0625 - 16.0 * z * y2 +
         16.0 * x2 * z;
}
...
double octic_function(double x, double y, double z) {  // r=2
  ...
  return 43.30495169 * x2 * y2 + 43.30495169 * x2 * z2 + 43.30495169 * y2 * z2 +
         44.36067980 * x6 * y2 + 44.36067980 * x6 * z2 + 66.54101970 * x4 * y4 +
         66.54101970 * x4 * z4 + 44.36067980 * x2 * y6 - 11.70820393 * x2 -
         11.70820393 * y2 - 11.70820393 * z2 + 37.65247585 * x4 +
         37.65247585 * y4 + 37.65247585 * z4 + 11.09016995 * x8 +
         11.09016995 * y8 + 11.09016995 * z8 + 133.0820394 * x2 * y4 * z2 +
         133.0820394 * x2 * y2 * z4 + 44.36067980 * x2 * z6 +
         44.36067980 * y6 * z2 + 66.54101970 * y4 * z4 + 44.36067980 * y2 * z6 +
         133.0820394 * x4 * y2 * z2 - 91.95742756 * x4 * y2 -
         91.95742756 * x4 * z2 - 91.95742756 * x2 * y4 - 91.95742756 * x2 * z4 -
         91.95742756 * y4 * z2 - 183.9148551 * x2 * y2 * z2 - 30.65247585 * x6 -
         30.65247585 * y6 - 91.95742756 * y2 * z4 - 30.65247585 * z6 +
         1.618033988;
}
...
double heart_function(double x, double y, double z) {  // radius = 2
  ...
  return (2 * x * x + y * y + z * z - 1) * (2 * x * x + y * y + z * z - 1) *
             (2 * x * x + y * y + z * z - 1) -
         (0.1 * x * x + y * y) * z * z * z;
}
...
double false_knot_function(double x, double y, double z) {  // radius = 1
  ...
  double f1 = x * (x * x - z * z) - 2 * x * z * z - y * y + d * d - x * x -
              z * z - y * y;
...
double knot2_function(double a, double b, double c) {  // radius = 4
  ...
  double f1t =
      (z3 - x7) * (z3 - x7 + 100 * x13) - (t3 - y7) * (t3 - y7 + 100 * y13);
  double f2t =
      (z3 - x7) * (t3 - y7 + 100 * y13) + (t3 - y7) * (z3 - x7 + 100 * x13);
